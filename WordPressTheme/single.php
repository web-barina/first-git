    ...
    <div class="blog-layout__inner inner">
        ...
        <div class="blog-layout__2column">
            ...
            <article class="blog-layout__main blog-article">
                ...
                <h1 class="blog-article__title title"><?php the_title() ?></h1>
                            ...
                            <?php
                                previous_post_link(
                                    ...
                                    '<svg class="pager__svg" width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="pager__path" d="M9 1L1 9L9 17" stroke="#FFE573" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg> '
                                );
                                ?> <?php
                                next_post_link(
                                    ...
                                    '<svg class="pager__svg" width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="pager__path" d="M1 1L9 9L1 17" stroke="#FFE573" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>'
                                );
                            ?>
                        </div>
